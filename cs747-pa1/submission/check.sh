...
# echo "Test $i"
# ./bandit.sh --instance ../instances/i-3.txt --algorithm ucb --randomSeed 33 --epsilon 0.403 --horizon 100
# sleep 1
# i=$((i + 1))

echo "Test $i"
./bandit.sh --instance ../instances/i-1.txt --algorithm kl-ucb --randomSeed 15 --epsilon 0.0 --horizon 204800
sleep 1
i=$((i + 1))
